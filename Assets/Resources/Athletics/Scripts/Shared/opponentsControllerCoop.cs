...
public class opponentsControllerCoop : MonoBehaviour {
	...
	void scoreBuilder(){
		...
		time4 = playerBehaviourCoop.playertime;
	...
	void Update(){
		...
		if (adversaryScript.termina && adversary2Script.termina && adversary3Script.termina && playerBehaviourCoop.termina && !end) {
