...
public class Player2Controller : MonoBehaviour
{
	...
	private ReturnBallP2 hitControllerPvP;
	...
	void Start()
	{
		...
		hitControllerPvP = hitArea.GetComponent<ReturnBallP2>();
		speed = 0;
		delay = 0;
		turnSpeed = 225;
		moveSpeed = 6;
		...
		if (cena == "TennisGamePvP"){
			hori = "HorizontalTenisP2";
			vert = "VerticalTenisP2";
		}else  {
			hori = "Horizontal";
			vert = "Vertical";
		}
	...
	void Update()
	{
		if (isServing == true)
		{
            //Debug.Log("Server True aqui OLHA OLHA");
	...
	void Sacar()
	{
		...
		{
            //Debug.Log("Pelo menos aqui chegou.");
