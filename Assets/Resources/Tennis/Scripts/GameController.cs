...
public class GameController : MonoBehaviour
{
    ...
    public void Ready()
    {
        ...
        if (cena == "TennisGamePvP"){
            Debug.Log("p2C referido");
            p2C = enemy.GetComponent<Player2Controller>();
        }else {
    ...
    private void StartGame()
    {
        ...
        if (serve == 1)
        {
            ...
            playerTurn = true;
            Debug.Log("Ball exists at "+ball.transform.position);
        }
        else if (serve == -1)
        {
            Debug.Log("Serve Lado 2");
            if (cena == "TennisGamePvP"){
                p2C.isServing = true;
            }else {
                eC.isServing = true;
